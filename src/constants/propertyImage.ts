...
<svg xmlns="http://www.w3.org/2000/svg" width="640" height="360" viewBox="0 0 640 360">
  ...
  <g fill="#94a3b8" transform="translate(270 110)">
  ...
  <text x="320" y="260" text-anchor="middle" fill="#64748b" font-family="system-ui,sans-serif" font-size="16">Property image unavailable</text>
</svg>`.trim());
